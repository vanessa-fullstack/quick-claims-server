...
public class BootstrapService {
    ...
    public void setUpInitialData(){
        ...
        if (numberOfClaims == 0) {
            QuickClaim newQuickClaim1 = new QuickClaim("Carly Smith", "Pet", 150.00, "Operation on dog", "Required to remove lump", "Active", LocalDate.of(2023, Month.JANUARY, 1), "124758960", null, null, null, null, "Dog", "Labrador");
            ...
            QuickClaim newQuickClaim6 = new QuickClaim("Maddie Wray", "Pet", 75.00, "cut on paw", "vet visit for cut on paw", "Active", LocalDate.of(2023, Month.JANUARY, 20), "123745601", null, null, null, null, "Dog", "Cocker Spaniel");
