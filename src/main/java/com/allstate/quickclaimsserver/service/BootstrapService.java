...
public class BootstrapService {
    ...
    public void setUpInitialData(){
        ...
        if (numberOfClaims == 0) {
            QuickClaim newQuickClaim1 = new QuickClaim("Carly Smith", "Pet", 150.00, "Operation on dog", "Required to remove lump", "Waiting", LocalDate.of(2023, Month.JANUARY, 1), "124758960", null, null, null, null, "Dog", "Labrador");
            QuickClaim newQuickClaim2 = new QuickClaim("Sam Reynolds", "Home", 300.00, "Flood damage", "Damage from floods last week", "Active", LocalDate.of(2022, Month.DECEMBER, 28), "121378412", "34 Elm Road", null, null, null, null, null);
            QuickClaim newQuickClaim3 = new QuickClaim("Maria Anders", "Pet", 150.00, "needed an operation", "Broken bone", "Closed", LocalDate.of(2022, Month.SEPTEMBER, 8), "128553017", null, null, null, null, "Cat", "British Shorthaired");
            QuickClaim newQuickClaim4 = new QuickClaim("Jane Brown", "Car", 250.00, "crack in window screen", "a stone hit the window screen and caused a crack", "Rejected", LocalDate.of(2023, Month.JANUARY, 14), "127541368", null, "Ford", "Focus", "2020", null, null);
            QuickClaim newQuickClaim5 = new QuickClaim("Alan Grey", "Home", 375.00, "boiler repairs", "no hot running water", "Closed", LocalDate.of(2022, Month.NOVEMBER, 13), "123078426", "87 Oak Street", null, null, null, null, null);
            QuickClaim newQuickClaim6 = new QuickClaim("Maddie Wray", "Pet", 75.00, "cut on paw", "vet visit for cut on paw", "Awaiting Payment", LocalDate.of(2023, Month.JANUARY, 20), "123745601", null, null, null, null, "Dog", "Cocker Spaniel");
            QuickClaim newQuickClaim7 = new QuickClaim("Tommy Murray", "Car", 255.00, "other car drove into back of car", "sitting in traffic and car behind went into back of car", "Rejected", LocalDate.of(2022, Month.OCTOBER, 11), "120886123", null, "Vauxhall", "Astra", "2021", null, null);
            ...
            QuickClaim newQuickClaim10 = new QuickClaim("Cain Hobbs", "Pet", 500.00, "operation", "dog needed neutered", "Passed on", LocalDate.of(2022, Month.AUGUST, 5), "125622489", null, null, null, null, "Dog", "German Shepard");
            QuickClaim newQuickClaim11 = new QuickClaim("Margaret Armstrong", "Car", 200.00, "service", "car check up", "Active", LocalDate.of(2022, Month.SEPTEMBER, 6), "126641208", null, "Ford", "Kuga", "2018", null, null);
            ...
            QuickClaim newQuickClaim13 = new QuickClaim("Mike Hanna", "Home", 155.00, "break in", "broken lock on door", "Awaiting Payment", LocalDate.of(2022, Month.OCTOBER, 30), "122351008", "81 Pine Avenue", null, null, null, null, null);
            ...
            QuickClaim newQuickClaim15 = new QuickClaim("Hannah Grey", "Pet", 95.00, "operation", "dog needed neutered", "Waiting", LocalDate.of(2023, Month.JANUARY, 30), "125354110", null, null, null, null, "Dog", "Labrador");
            ...
            QuickClaim newQuickClaim20 = new QuickClaim("Natalie Rooney", "Car", 200.00, "wing mirror off", "other car knocked off wing mirror", "Active", LocalDate.of(2023, Month.JANUARY, 16), "127451224", null, "Vauxhall", "Astra", "2020", null, null);
